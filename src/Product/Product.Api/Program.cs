...
builder.Services.AddMediatR(cfg =>
    cfg.RegisterServicesFromAssemblyContaining<Product.Application.Commands.CreateProductCommand>());
...
builder.Services.AddScoped<Product.InternalContracts.IProductQueryRepository, ProductRepository>();
